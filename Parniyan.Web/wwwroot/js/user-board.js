(function($) {
	var $user_quickview_toggler = $('.user-quickview'),
		...
		$settings_toggler.bind( 'click', { selector: true }, toggleDropdown );
		$email_toggler.bind( 'click', { selector: true }, toggleDropdown );
		$cart_toggler.bind( 'click', { selector: true }, toggleDropdown );
