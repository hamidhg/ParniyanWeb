(function($) {
	...
	$mobile_menu_handler.bind('click', { id: '#mobile-menu' }, showSideMenu );
	$mobile_menu.children('.svg-plus').bind('click', { id: '#mobile-menu' }, showSideMenu );

	$mobile_account_options_handler.bind('click', { id: '#account-options-menu' }, showSideMenu );
	$account_options_menu.children('.svg-plus').bind('click', { id: '#account-options-menu' }, showSideMenu );
